...
SECRET_KEY = "django-insecure-1hw*snex462ze56&2kyjm^(1nb2o66rxa#5kxehqh=16_k=dk3"
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API documentation of all the endpoints for the visitor management system',
    'VERSION': '1.0.0',
